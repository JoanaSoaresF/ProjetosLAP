...
class Actor {
    constructor(x, y, imageName) {
		...
		this.show();
		//
		this.isFree = false;  //available to move to
...
class ActiveActor extends Actor {
	...
	move(dx, dy) {
		if (control.world[y + dy][x + dx].isFree() && control.worldActive[y + dy][x + dx].isFree()) {
			if (control.worldActive[y + dy][x + dx].isColectable)
				control.worldActive[y + dy][x + dx].colect();
			//
			this.hide();
			this.x += dx;
			this.y += dy;
	...
	canMove(dx,dy){
		return control.world[y + dy][x + dx].isFree() && control.worldActive[y + dy][x + dx].isFree()
	}
}
